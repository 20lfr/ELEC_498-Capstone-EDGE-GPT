...
module drive_group_head_phase_tb;
  ...
  logic        ap_idle;
  logic        ap_ready;
  logic [65:0] head_ctx_ref_i;
  logic [65:0] head_ctx_ref_o;
  logic        head_ctx_ref_o_ap_vld;
  ...
  drive_group_head_phase dut (
      ...
      .ap_idle             (ap_idle),
      .ap_ready            (ap_ready),
      .head_ctx_ref_i      (head_ctx_ref_i),
      .head_ctx_ref_o      (head_ctx_ref_o),
      .head_ctx_ref_o_ap_vld(head_ctx_ref_o_ap_vld),
  ...
  always_ff @(posedge clk) begin
    if (ap_rst) begin
      ...
      gb = base_head_idx;
      if (head_ctx_ref_o_ap_vld && gb < HEADS_TOTAL) begin
        head_ctx_shadow[gb] <= head_ctx_ref_o;
      end
    end
  end
    ...
    for (genvar h = 0; h < HEADS_TOTAL; h++) begin : COMPUTE_MODEL
      ...
      always_ff @(posedge clk) begin
        if (ap_rst) begin
          ...
          if (h == base_head_idx && head_ctx_ref_o_ap_vld) begin
            compute_start_now = head_ctx_ref_o[42]; // bit 42 is compute_start
          end else begin
