...
#define AUTOTB_TVIN_start_r "../tv/cdatafile/c.run_single_head.autotvin_start_r.dat"
#define AUTOTB_TVOUT_start_r "../tv/cdatafile/c.run_single_head.autotvout_start_r.dat"
...
extern "C"
hls::sim::Byte<1> run_single_head_hw_stub_wrapper(void*, hls::sim::Byte<4>, hls::sim::Byte<1>);

extern "C"
hls::sim::Byte<1> apatb_run_single_head_hw(void* __xlx_apatb_param_ctx, hls::sim::Byte<4> __xlx_apatb_param_layer_idx, hls::sim::Byte<1> __xlx_apatb_param_start_r)
{
  ...
  try {
    ...
    ap_return = run_single_head_hw_stub_wrapper(__xlx_apatb_param_ctx, __xlx_apatb_param_layer_idx, __xlx_apatb_param_start_r);
