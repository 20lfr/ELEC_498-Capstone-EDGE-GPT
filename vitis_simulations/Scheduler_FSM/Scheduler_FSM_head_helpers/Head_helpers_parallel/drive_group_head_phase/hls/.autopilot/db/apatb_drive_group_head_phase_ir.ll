...
define i1 @apatb_drive_group_head_phase_ir([2 x %struct.HeadCtx]* noalias nonnull dereferenceable(48) "partition" %head_ctx_ref, i32 %group_idx, i32 %layer_idx, i1 zeroext %start) local_unnamed_addr #0 {
entry:
  ...
  %0 = call i1 @apatb_drive_group_head_phase_hw(i66* %head_ctx_ref_copy_0, i66* %head_ctx_ref_copy_1, i32 %group_idx, i32 %layer_idx, i1 %start)
