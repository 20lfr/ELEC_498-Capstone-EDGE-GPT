...
HLS_SOURCES = ../../../../../../../../HLS-Verilog/Scheduler_FSM/Scheduler_tb.cpp ../../../../../../../../HLS-Verilog/Scheduler_FSM/Scheduler_FSM.cpp
...
$(ObjDir)/Scheduler_tb.o: ../../../../../../../../HLS-Verilog/Scheduler_FSM/Scheduler_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../../../HLS-Verilog/Scheduler_FSM/Scheduler_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/Scheduler_tb.d
