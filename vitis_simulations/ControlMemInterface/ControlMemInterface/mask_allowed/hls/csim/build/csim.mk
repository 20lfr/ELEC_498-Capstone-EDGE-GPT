...
HLS_SOURCES = ../../../../../../../HLS-Verilog/ControlMemInterface/ControlMemInterface_tb.cpp ../../../../../../../HLS-Verilog/ControlMemInterface/ControlMemInterface.cpp
...
$(ObjDir)/ControlMemInterface_tb.o: ../../../../../../../HLS-Verilog/ControlMemInterface/ControlMemInterface_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../../../HLS-Verilog/ControlMemInterface/ControlMemInterface_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ControlMemInterface_tb.d
